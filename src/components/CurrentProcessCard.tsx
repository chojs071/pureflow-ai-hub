    ...
    <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6 sm:p-7 shadow-sm space-y-6">
      ...
      <div>
        <div className="flex flex-wrap items-center justify-between gap-2 mb-1.5">
          ...
          <span className="text-xs font-mono text-[#64748B]">Ref: {process.referenceDoc}</span>
        </div>
        <h2 className="text-2xl font-black tracking-tight text-[#071A2E]">{process.name}</h2>
        <p className="text-sm font-semibold text-[#00C2FF] mt-0.5">{process.subName}</p>
        <p className="text-xs text-[#64748B] mt-2 leading-relaxed">{process.description}</p>
      </div>
      ...
      >
        ...
        <p className="text-[10px] text-[#64748B] mt-2.5 leading-normal">
          ※ 허용 기준은 공정 및 오염물 종류에 따라 달라지며, PureFlow AI는 품질 기준을 충족하지
          못하는 후보 조건을 원천 제외합니다.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-3.5">
          <span className="text-[11px] font-medium text-[#64748B] block mb-1">기존 UPW 사용량</span>
        ...
        <div className="rounded-xl border-2 border-[#00C2FF] bg-[#00C2FF]/5 p-3.5 ring-1 ring-[#00C2FF]/20 shadow-xs">
          <div className="flex items-center justify-between mb-1">
            <span className="text-[11px] font-bold text-[#071A2E]">AI 추천 UPW</span>
        ...
        <div className="rounded-xl border border-[#22C55E]/30 bg-[#22C55E]/10 p-3.5">
          <span className="text-[11px] font-bold text-[#166534] block mb-1">초순수 절감량</span>
          <div className="flex items-baseline gap-1">
        ...
        <div className="rounded-xl border border-[#22C55E]/30 bg-[#22C55E]/10 p-3.5">
          ...
          <div className="flex items-baseline gap-1 text-[#166534]">
            <span className="font-mono text-xl sm:text-2xl font-black">{savingsPercent}</span>
      ...
      <div className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
          <div className="rounded-lg bg-white p-2.5 border border-[#E2E8F0]">
            ...
            <div className="flex items-baseline gap-1 mt-1 font-mono font-bold text-[#071A2E]">
              <span className="text-[#94A3B8] line-through text-[11px]">
                {process.baselineRecipe.cleaningTimeMin}m
              </span>
              <span>→</span>
          ...
          <div className="rounded-lg bg-white p-2.5 border border-[#E2E8F0]">
            ...
            <div className="flex items-baseline gap-1 mt-1 font-mono font-bold text-[#071A2E]">
              <span className="text-[#94A3B8] line-through text-[11px]">
                {process.baselineRecipe.rinseTimeMin}m
              </span>
              <span>→</span>
          ...
          <div className="rounded-lg bg-white p-2.5 border border-[#E2E8F0]">
            ...
            <div className="flex items-baseline gap-1 mt-1 font-mono font-bold text-[#071A2E]">
              <span className="text-[#94A3B8] line-through text-[11px]">
                {process.baselineRecipe.flowRateLpm}
              </span>
              <span>→</span>
