    ...
    <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="text-sm font-bold text-[#166534]">
              품질 검증 요약: {summary.processesPassedCount} / {summary.totalProcessesCount} 공정
              품질 기준 통과 (100%)
            </h4>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
        ...
        <div className="rounded-xl border border-[#E2E8F0] bg-white p-4 shadow-xs">
          <span className="text-[11px] font-medium text-[#64748B] block mb-1">기존 총 UPW</span>
        ...
        <div className="rounded-xl border-2 border-[#00C2FF] bg-[#00C2FF]/5 p-4 shadow-xs ring-1 ring-[#00C2FF]/20">
          <span className="text-[11px] font-bold text-[#071A2E] block mb-1">AI 최적화 UPW</span>
          <div className="flex items-baseline gap-1">
        ...
        <div className="rounded-xl border border-[#22C55E]/30 bg-[#22C55E]/10 p-4 shadow-xs">
          <span className="text-[11px] font-bold text-[#166534] block mb-1">총 UPW 절감량</span>
          <div className="flex items-baseline gap-1 text-[#166534]">
            <span className="font-mono text-2xl font-black">{summary.totalSavingsUPW}</span>
        ...
        <div className="rounded-xl border border-[#22C55E]/30 bg-[#22C55E]/10 p-4 shadow-xs">
          ...
          <div className="flex items-baseline gap-1 text-[#166534]">
            <span className="font-mono text-2xl font-black">{summary.totalSavingsPercent}</span>
        ...
        <div className="rounded-xl border border-[#E2E8F0] bg-white p-4 shadow-xs col-span-2 lg:col-span-1">
          <span className="text-[11px] font-medium text-[#64748B] block mb-1">품질 기준 충족</span>
          ...
          <span className="text-[10px] text-[#22C55E] font-bold mt-1 block">100% Quality Pass</span>
        </div>
      </div>
          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tfoot>
              <tr className="bg-[#071A2E]/5 font-bold text-[#071A2E] border-t border-[#E2E8F0]">
                ...
                <td className="py-3 px-3 text-right font-mono text-[#00C2FF]">
                ...
                <td className="py-3 px-3 text-right font-mono text-[#166534]">
                  -{summary.totalSavingsUPW} L
                </td>
                <td className="py-3 px-3.5 text-right font-mono text-[#166534]">
