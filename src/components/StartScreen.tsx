        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-5">
            ...
            <button
              ...
              className="inline-flex items-center gap-2.5 rounded-full border border-[#CBD5E1] bg-white px-5 py-1.5 text-xs sm:text-sm font-bold text-[#071A2E] hover:border-[#00C2FF] hover:bg-[#00C2FF]/10 transition-colors shadow-xs cursor-pointer"
            >
