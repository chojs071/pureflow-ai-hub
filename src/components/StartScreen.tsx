  ...
  return (
    <div className="min-h-[calc(100vh-65px)] flex flex-col justify-between py-10 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="max-w-2xl sm:max-w-3xl mx-auto rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] p-6 sm:p-8 mb-12 text-center shadow-xs">
            ...
            <p className="text-xs sm:text-sm text-[#64748B] mt-3 leading-relaxed">
              공정별 허용 잔류 오염 기준(Cu atoms/cm²)을 최우선 검증 후 최소 초순수 조건을
              도출합니다.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto mb-10 text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              >
                <div
                  className={`h-16 w-16 rounded-full border-2 flex items-center justify-center mb-3.5 transition-colors ${
                    selectedWafer === "200mm"
                ...
                <span className="text-xs sm:text-sm text-[#64748B] mt-1 font-medium">
                  8-inch Legacy / Power Fab
                </span>
                {selectedWafer === "200mm" && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-xs">
            ...
            <p className="text-xs text-[#64748B] leading-relaxed">
              임의 점수가 아닌 Cu 잔류 오염(atoms/cm²) 허용 기준을 모델링하여, 기준을 초과하는
              조건은 즉시 탈락 처리합니다.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-xs">
            ...
            <p className="text-xs text-[#64748B] leading-relaxed">
              품질 기준을 충족한 후보군 중 유량(L/min)과 린스 시간(min)을 수학적으로 비교하여 최소
              UPW 조건을 추천합니다.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-xs">
            ...
            <p className="text-xs text-[#64748B] leading-relaxed">
              절감된 초순수(L)를 기반으로 고순도 처리 전력(kWh) 및 탄소 배출 저감량(kgCO₂e)을 정량
              산출합니다.
            </p>
          </div>
        </div>
      ...
      <div className="pt-6 border-t border-[#E2E8F0] text-center text-xs text-[#64748B] flex flex-col sm:flex-row items-center justify-between gap-2">
        <p>
          ※ 본 시스템은 실제 팹 장비 제어가 아닌, ECS / IEEE 학술 문헌 기반 Surrogate 시뮬레이션
          모델을 사용합니다.
        </p>
        <button
