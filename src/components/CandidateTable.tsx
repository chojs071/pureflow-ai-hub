      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[11px] text-[#64748B] mt-0.5">
            품질 기준(≤ {formatScientific(allowableCu)})을 충족한 후보 중 가장 적은 UPW를 자동 선정합니다.
          </p>
        </div>
      </div>
                ...
                >
                  ...
                  <td className="py-2.5 px-3">
                    <div className="flex items-center gap-1.5 font-mono">
                      <span className={`font-bold ${isRecommended ? 'text-[#071A2E] text-sm' : isPass ? 'text-[#0F172A]' : 'text-rose-900 line-through'}`}>
                  ...
                  <td className="py-2.5 px-3 font-mono">
                    <span className={isPass ? (isRecommended ? 'text-[#071A2E] font-bold' : 'text-[#0F172A]') : 'text-rose-700 font-bold'}>
                  ...
                  <td className="py-2.5 px-3 text-right">
                    {isRecommended ? (
                      ...
                      <span className="text-[11px] text-rose-600 font-medium">제외 (품질 미달)</span>
                    )}
                  </td>
                </tr>
              );
