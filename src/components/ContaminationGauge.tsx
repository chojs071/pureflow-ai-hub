    ...
    <div className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-4">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span
            className={`rounded-md px-2 py-0.5 text-[11px] font-bold ${bandInfo.bgColor} ${bandInfo.color} border ${bandInfo.borderColor}`}
          >
      ...
      {isHighContaminationLocked && (
        <div className="mt-3 flex items-start gap-2 rounded-lg bg-rose-50 border border-rose-200 p-2.5 text-xs text-rose-800">
          ...
          <div>
            ...
            오염도 90 이상 공정은 품질 손실을 방지하기 위해 최소 린스/세정시간 이하로 감축하지
            않습니다.
          </div>
        </div>
      )}
