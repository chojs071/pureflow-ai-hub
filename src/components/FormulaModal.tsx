      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-[#E2E8F0] pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-[#64748B]">반도체 초순수 세정/린스 수식 및 문헌 근거</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="rounded-xl border border-[#00C2FF]/30 bg-[#071A2E] text-white p-5 space-y-3">
          ...
          <p className="text-xs text-white/70 leading-relaxed">
            세정/린스 시간(t), 유량 비율(Q/Q_ref), 사이클 수(N)에 따른 지수함수적 표면 구리(Cu) 오염
            제거율을 계산합니다.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-4 text-xs space-y-2">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[#64748B]">
            <li>
              <strong className="text-[#071A2E]">R_pred</strong>: 세정 후 예상 잔류 Cu (atoms/cm²)
            </li>
            <li>
              <strong className="text-[#071A2E]">R_initial</strong>: 공정 시작 전 초기 Cu 오염도
            </li>
            <li>
              <strong className="text-[#071A2E]">R_floor</strong>: 모델상 물리적 최소 잔류치
            </li>
            <li>
              <strong className="text-[#071A2E]">t</strong>: 유효 세정/린스 시간 (min)
            </li>
            <li>
              <strong className="text-[#071A2E]">Q / Q_ref</strong>: 초순수 공급 유량 비율 (L/min)
            </li>
            <li>
              <strong className="text-[#071A2E]">N</strong>: 세정/린스 사이클 수
            </li>
            <li>
              <strong className="text-[#071A2E]">K, α, β</strong>: 공정별 속도 보정 계수 및 민감도
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-xl border border-[#22C55E]/30 bg-[#22C55E]/10 p-4 text-xs space-y-2">
          ...
          <p className="text-[#166534] leading-relaxed">
            PureFlow AI는 점수화(0~100) 방식이 아닌{" "}
            <strong>물리적 허용 오염 기준(예: ≤ 1.0 × 10¹⁰ atoms/cm²)</strong>을 먼저 통과한 후보군
            중에서만 UPW 최소화 조건을 선택합니다.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1.5 text-[11px] text-[#64748B]">
            <p className="p-2 rounded-lg bg-[#F8FAFC] border border-[#E2E8F0]">
              • <strong>Tsutano K. et al. (2025)</strong>, "Wafer-surface metal adsorption in single
              wafer DIW rinse", <em>ECS J. Solid State Sci. Technol.</em>
            </p>
            <p className="p-2 rounded-lg bg-[#F8FAFC] border border-[#E2E8F0]">
              • <strong>Tsang C.F. et al. (2005)</strong>, "Wet clean impacts on Cu/low-k post-etch
              residue and reliability", <em>Microelectronics Reliability 45</em>.
            </p>
            <p className="p-2 rounded-lg bg-[#F8FAFC] border border-[#E2E8F0]">
              • <strong>IEEE TSM (2017) & ECS JSST (2020)</strong>, "Spin rinse dynamics,
              re-adhesion, and water usage minimization in high-aspect-ratio wafer features".
            </p>
          </div>
        </div>
