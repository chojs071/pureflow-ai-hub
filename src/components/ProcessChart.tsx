    ...
    <div className="rounded-2xl border border-[#E2E8F0] bg-white p-5 shadow-xs space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5 rounded-lg bg-[#22C55E]/10 border border-[#22C55E]/20 px-2.5 py-1 text-xs font-bold text-[#166534]">
          ...
          <span>총 {totalSavings.toFixed(1)}L 절감 (-{savingsRate}%)</span>
        </div>
      </div>
        ...
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={chartData} margin={{ top: 10, right: 10, left: -15, bottom: 0 }}>
            ...
            <Legend
              ...
              formatter={(value) => {
                if (value === 'baselineUPW') return <span className="text-[#64748B]">기존 UPW</span>;
                if (value === 'recommendedUPW') return <span className="text-[#071A2E] font-bold">AI 최적화 UPW</span>;
                return value;
              }}
            />
